...
;           int samplingRate = (int)configuration.SampleRates[0].SamplingFrequency;
        ...
        public void ReadAllVoltages()
        {
            ...
            {
                DateTime timeStamp = _comtradeData.Configuration.StartTime.AddSeconds(i / _comtradeData.Configuration.SampleRates[0].SamplingFrequency);
        ...
        public void FindPhaseVoltageIndices()
        {
            ...
            {
                throw new Exception("Не удалось автоматически определить индексы всех трёх фахных напряжений." +
